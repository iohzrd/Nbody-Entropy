//! N-body Entropy CLI - Command-line interface for the GPU-accelerated n-body entropy generator
...
fn run_nist_tests(sample_size: usize) {
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║  NIST SP 800-22 Inspired Statistical Test Suite (GPU)       ║");
    println!(
...
fn print_usage() {
    eprintln!("nbody-entropy - GPU-accelerated entropy from N-body simulation\n");
    ...
    eprintln!("  benchmark       Measure GPU generation speed");
    eprintln!();
    eprintln!("Examples:");
